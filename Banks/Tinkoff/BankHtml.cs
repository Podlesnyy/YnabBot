...
public sealed class BankHtml : IBank
{
    ...
    public bool IsItYour( string fileName ) => fileName.Contains( "Т-Банк" );
    ...
    public List< Transaction > Parse( string fileContent )
    {
        ...
        var nodes = doc.DocumentNode.SelectNodes( "//p[@content='h2'] | //div[starts-with(@aria-label,'Детали операции')]" );
